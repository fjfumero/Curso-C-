...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ClientSize = System::Drawing::Size(460, 171);
...
#pragma endregion
		void Aleatorios()
		{
			...
			int Temp1 = aleatorio->Next(1, (10 + 1));	// generamos los dos numeros aleatorios
			int Temp2 = aleatorio->Next(1, (10 + 1));	// entre 1 y 10
			int Temp3 = aleatorio->Next(1, 4);			// generamos otro numero aleatorio entre 1 y 3
			label2->Text = Convert::ToString(Temp3);	// pasamos el numero aleatorio al texto de la etiqueta2
			label2->Visible = false;					// 
			label3->Visible = false;
			label4->Visible = false;						// etiqueta para llevar el conteo de intentos

			switch (Temp3)		// Segun el valor de Temp3 seleccionamos cual campo 
								// estara habilitado y cuales no
			{
			case 1:
